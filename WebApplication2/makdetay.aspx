<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="makdetay.aspx.cs" Inherits="WebApplication2.makdetay" %>
                ...
                <div style="width:690px; margin:0 auto; height:auto;">
                    <div class="auto-style6">
                        ...
                        <div style="width: 650px; height: 40px; float: left; background-color: #000066; color: #FFFFFF;">
                           <a href="makaledetay.aspx?makaleID=<%# Eval("makaleID") %>"><asp:Label ID="Label1" runat="server" Height="37px" Text='<%# Eval("makaleBaslik") %>' Width="359px" Font-Size="Large" ForeColor="White"></asp:Label></a> 
                        </div>
                    ...
                    <div style="width:690px; float:left; height:70px; line-height:20px; font-size:12px;background-color:aliceblue;">
                        <div style="width:auto; height:20px; float:left;">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="textboxGorsel" Height="69px" TextMode="MultiLine" Width="689px" Text='<%# Eval("makaleIcerik") %>'></asp:TextBox>
